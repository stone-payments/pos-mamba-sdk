 ...
 */
export function print (element, config, callback) {
    ...
    if (typeof element === 'object') {
      ...
      if (
        ...
        setTimeout(function () {
          ...
          if (Printer.SimulatedConfigurations.should_fail) {
            const err = new Error('Failed to print')
            callback(err)
          } else {
            callback()
          }
        }, Printer.SimulatedConfigurations.printing_time)
      }
    } else {
 ...
 */
export function failedPrinting () {
  return Printer.SimulatedConfigurations.should_fail
}
...
const Printer = {
   ...
   * @namespace PrinterSimulatedConfigurations
   * @type {object}
   * @memberOf Printer
