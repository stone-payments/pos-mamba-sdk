...
export default function setup(System) {
   ...
   */
  System.hasEthernet = () => config.Connections.ethernet;
   ...
   */
  System.hasWifi = () => config.Connections.wifi;
   ...
   */
  System.hasGprs = () => config.Connections.gprs;
   ...
   */
  System.isBatteryPresent = () => config.Battery.present;
   ...
   */
  System.getPowerSupply = () => config.PowerSupply;
   ...
   */
  System.getTimeFromBoot = () => config.TimeFromBoot;
   ...
   */
  System.getSerialNumber = () => config.SerialNumber;
   ...
   */
  System.getBatteryStatus = () => config.Battery.status;
   ...
   */
  System.getBatteryLevel = () => config.Battery.level;
