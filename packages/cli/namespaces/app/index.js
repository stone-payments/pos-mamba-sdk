...
module.exports = {
  ...
  builder: (yargs) => {
    if (PKG == null) {
      console.error(pico.red('No "package.json" found. Is this a mamba app directory?"'));
      process.exit(1);
    }
    ...
    if (typeof PKG.mamba === 'undefined') {
      console.error(
        pico.red(`No "mamba" property found at "${PKG.rootDir}" Is this an mamba app directory?"`),
      );
      process.exit(1);
    }
