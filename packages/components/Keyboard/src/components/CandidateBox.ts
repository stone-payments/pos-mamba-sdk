...
class CandidateBox {
  ...
  renderPage({
    ...
    this.candidateBoxElement.className = 'mb-candidate-box';

    // Candidate box list
    const candidateListULElement = document.createElement('ul');
    candidateListULElement.className = 'mb-candidate-box-list';
    ...
    candidateListPages[pageIndex].forEach((candidateListItem) => {
      ...
      candidateListLIElement.className = 'mb-candidate-box-list-item';
    ...
    prevBtnElement.classList.add('mb-candidate-box-prev');
    // eslint-disable-next-line no-unused-expressions
    isPrevBtnElementActive && prevBtnElement.classList.add('mb-candidate-box-btn-active');
    ...
    nextBtnElement.classList.add('mb-candidate-box-next');
    // eslint-disable-next-line no-unused-expressions
    isNextBtnElementActive && nextBtnElement.classList.add('mb-candidate-box-btn-active');
