...
export const floor = (value, decimals = 2) =>
  Number(`${Math.floor(Number(`${parseFloat(value)}e${decimals}`))}e-${decimals}`);

export const round = (value, decimals = 2) =>
  Number(`${Math.round(Number(`${parseFloat(value)}e${decimals}`))}e-${decimals}`);

export const ceil = (value, decimals = 2) =>
  Number(`${Math.ceil(Number(`${parseFloat(value)}e${decimals}`))}e-${decimals}`);
